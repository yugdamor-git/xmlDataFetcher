...
{
    let api_key = "Bearer "
...
function saveFile(parsed_listings)
{
  ...
  function parse_listing(listing) {
    ...
    for (const [key, v] of Object.entries(listing)) {
      ...
      else if (key == "count" || key == "Unit_Builtup_Area" || key == "No_of_Bathroom"|| key == "Bedrooms" || key == "Price" || key == "No_of_Rooms" || key == "Parking")
      {
          try{
